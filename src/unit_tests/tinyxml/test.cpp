...
int tinyxml_test()
{
	...
	printf ("\n** UTF-8 **\n");
	{
		TiXmlDocument doc( "tinyxml/utf8test.xml" );
		doc.LoadFile();
		if ( doc.Error() && doc.ErrorId() == TiXmlBase::TIXML_ERROR_OPENING_FILE ) {
			printf( "WARNING: File 'tinyxml/utf8test.xml' not found.\n"
		...
		else
		{
			...
			doc.SaveFile( "tinyxml/utf8testout.xml" );
			...
			FILE* saved  = fopen( "tinyxml/utf8testout.xml", "r" );
			FILE* verify = fopen( "tinyxml/utf8testverify.xml", "r" );
			if ( saved && verify )
			{
